    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          const BottomNavigationBarItem(icon: Icon(Icons.sports_volleyball), label: '体育祭'),
          const BottomNavigationBarItem(icon: Icon(Icons.account_balance), label: '文化祭'),
          const BottomNavigationBarItem(icon: Icon(Icons.people_outline_sharp), label: '全校企画'),
