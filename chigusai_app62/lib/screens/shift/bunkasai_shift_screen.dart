    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              _bunkasaiDay == GakusaiDay.bunkasai1 ? '9/14 文化祭1日目' : '9/15 文化祭2日目',
...
//update shift data 関連
  void _setDialogData(BunkasaiShiftData bunkasaiShiftData) {
    ...
    _startTime = DateTime(2024, 9, _day, bunkasaiShiftData.startTime.hour, bunkasaiShiftData.startTime.minute);
    _endTime = DateTime(2024, 9, _day, bunkasaiShiftData.endTime.hour, bunkasaiShiftData.endTime.minute);
